...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@pnghai/ichigoswap-sdk'
import { Button, CardBody, AddIcon, Text as UIKitText } from '@pnghai/ichigoswap-uikit'
...
export default function AddLiquidity({
  ...
  async function onAdd() {
    ...
    const deadlineFromNow = Math.ceil(Date.now() / 1000) + deadline*100
