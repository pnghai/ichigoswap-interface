import { ChainId, Pair, Token } from '@pnghai/ichigoswap-sdk'
import flatMap from 'lodash.flatmap'
import { useCallback, useMemo } from 'react'
import { shallowEqual, useDispatch, useSelector } from 'react-redux'
import { BASES_TO_TRACK_LIQUIDITY_FOR, INIT_CODE, PINNED_PAIRS, STBE_FACTORY_ADDRESS } from '../../constants'
...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB, STBE_FACTORY_ADDRESS, INIT_CODE), 18, 'STBE-LP', 'Strawberry LPs')
}
